...
##### Context
*Inkwell* is a one-semester course project. A small team will build it step by step. 
The project already uses React, Express, PostgreSQL, and Prisma.

We need an architecture that is easy to build and maintain. 
It should support gradual development throughout the course. 
It should also avoid unnecessary complexity. At the same time,
